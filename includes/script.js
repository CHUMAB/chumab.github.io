...
fetch("https://5v236mrs.usw2.devtunnels.ms:3000/posts")//json FETCH from laptop
                              ...
                              if (titleString === uniqueKey) {
                                ...
                                const nameChange = {
                                  title: "DELETED"
                                    ...
                                    fetch("https://5v236mrs.usw2.devtunnels.ms:3000/posts/" + obj.id, {//this changes the "randomNum" to "DELETED" so it no longer loads
                                      method: "PUT",
...
$("#addClass").click(function() {//task adder both to site and JSON
    ...
    console.log("pressed");
            ...
            fetch("https://5v236mrs.usw2.devtunnels.ms:3000/posts",//json POST to laptop
            {
                method: "POST",
                body: JSON
                .stringify
